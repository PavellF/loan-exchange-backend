...
import com.pavelf.loanexchange.web.rest.errors.EmailNotFoundException;
...
public class AccountResource {
    ...
    public void registerAccount(@Valid @RequestBody ManagedUserVM managedUserVM) {
        ...
        String role = AuthoritiesConstants.CREDITOR;

        if (AuthoritiesConstants.DEBTOR.equals(managedUserVM.getRole())) {
            role = AuthoritiesConstants.DEBTOR;
        }
