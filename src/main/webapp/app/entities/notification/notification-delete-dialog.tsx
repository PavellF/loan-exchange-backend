  ...
  render() {
    ...
    return (
      <Modal isOpen toggle={this.handleClose}>
        ...
        <ModalBody id="loanExchangeBackendApp.notification.delete.question">
          <Translate contentKey="loanExchangeBackendApp.notification.delete.question" interpolate={{ id: notificationEntity.id }}>
